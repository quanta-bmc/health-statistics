#!/bin/bash
##
## Monitor dbus when RequestedHostTransition propertiesChanged, then set to the requested_host_transition sensor
##
type='signal'
...
pattern='RequestedHostTransition'
service_name2='xyz.openbmc_project.HealthStatistics'
obj_path2='/xyz/openbmc_project/sensors/oem/requested_host_transition'
